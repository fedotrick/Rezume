...
"Данные — это новая нефть. Но, как и нефть, их нужно переработать, чтобы они приносили пользу."
...
🗄️ Базы данных
BigQuery ClickHouse MySQL SQLite

⚙️ Инструменты
Docker Jupyter Excel Google Sheets Git
